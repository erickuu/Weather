...
const URL = 'http://api.weatherapi.com/v1/current.json?key=4cc20ceba315426996f43152212712&aqi=no';
let COUNTRY = '';
let data = '';
...
// Data Hnadler   
function handlerData(weather){
  for(var i = 0; itemArr.length; i++) {
    itemArr[i].innerHTML = weather.data.current[props[i]];    
  }
  console.log(weather);
};

console.log('Hey sigueme en github.com/erickuu');
},{"axios":2}]},{},[32]);
